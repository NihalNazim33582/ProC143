...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "http://8f20221fc51a.ngrok.io/all-articles";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "http://8f20221fc51a.ngrok.io/liked-articles";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  dislikedArticle = () => {
    const url = "http://6ded76c4a815.ngrok.io/disliked-articles";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
